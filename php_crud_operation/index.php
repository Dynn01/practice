...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="btn btn-light" href="delete.php?id_siswa=<?php echo $key["id_siswa"]; ?>">hapus</a>|<a class="btn btn-light" href="edit.php?id_siswa=<?php echo $key["id_siswa"]; ?>">edit</a></td>
    </tr>
      <?php endforeach; ?>
  </tbody>
</table>
...
<form action="input.php" method="POST">
  ...
  <button type="submit" class="btn btn-primary d-flex mx-auto mt-5">Submit</button>
</form>
